<template>
  ...
  <button
    type="button"
    class="m-4 inline-flex items-center justify-center rounded-md p-2.5 text-white"
    data-modal-toggle="defaultModal"
  >
    <span class="sr-only">Open main menu</span>
    <Icon name="material-symbols:menu"></Icon>
  </button>
  ...
  >
    <div class="relative w-full h-full max-w-2xl md:h-auto">
      ...
      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
        ...
        >
          <h3 class="text-xl font-semibold text-gray-900 dark:text-white">Menu</h3>
          <button
            type="button"
        ...
        <div class="p-6 space-y-6 grid grid-cols-1">
          <a href="#home3" data-modal-toggle="defaultModal">
            <button
              type="button"
