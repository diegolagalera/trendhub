<template>
  <!-- component -->
  <!-- component -->
  <div class="btncustom flex items-center shadow-2xl rounded-2xl">
    <div
      class="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-800 p-4 rounded-2xl border max-w-xs bg-re-400"
    >
      ...
      <p
        class="text-gray-500 dark:text-gray-400 text-xs text-start py-1 my-0.5"
      >
      ...
      ></div>
      <div class="text-gray-600 text-xs dark:text-gray-400 flex">
        ...
        <div class="flex items-center w-full">
          ...
          <span class="ml-3">93 people are Tweeting</span>
        </div>
      </div>
    </div>
  </div>
